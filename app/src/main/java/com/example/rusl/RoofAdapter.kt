...
class RoofAdapter(private val apartamentsList: MutableList<Roof>) : RecyclerView.Adapter<RoofAdapter.RestaurantViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RestaurantViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_roof, parent, false)
    ...
    fun updateRestaurant(position: Int, updatedApartaments: Roof) {
        apartamentsList[position] = updatedApartaments
        notifyDataSetChanged()
    }
    private fun showEditRestaurantDialog(apartaments: Roof, position: Int, context: Context) {
        val builder = AlertDialog.Builder(context)
        builder.setTitle("Редагувати")

        val view = LayoutInflater.from(context).inflate(R.layout.edit_roof, null)
